...
export const AppSidebar = () => {
  ...
  return (
    <Sidebar
      className={`glass-morphism h-full border-r-0 ${isMobile ? 'mobile-sidebar' : ''}`}
    ...
    >
      ...
      <SidebarContent className="text-base ml-2 mr-2 my-6 text-high-emphasis font-normal overflow-x-hidden space-y-8">
        <MenuSection
