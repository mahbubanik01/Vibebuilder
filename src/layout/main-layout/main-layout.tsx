    ...
    <div className="flex w-full min-h-screen relative">
      ...
      <div
        className={`flex flex-col w-full h-full ${
          marginClass
        } transition-[margin-left] duration-300 ease-in-out bg-[#fafafa]`}
      >
        <div className="sticky glass-morphism z-30 top-0 py-3 px-4 sm:px-6 md:px-8 flex justify-between items-center w-full shadow-sm">
        ...
        <div
          className={`flex h-full ${!isEmailRoute && !isChatRoute && 'p-4 sm:p-6 md:p-10'} ${open && !isMobile ? 'w-[calc(100dvw-var(--sidebar-width))]' : 'w-full'} max-w-[1600px] mx-auto`}
        >
          <Outlet />
        </div>
      </div>
