...
export const GeneralInfo = () => {
  ...
  const isBrowserStorageSet = useRef(false);
  ...
  useEffect(() => {
    if (!userInfo || isBrowserStorageSet.current) return;
    ...
    if (shouldSetMfaState) {
      browserStorage.setItem('initialMfaUserState', String(userInfo.mfaEnabled));
      isBrowserStorageSet.current = true;
    }
  }, [userInfo]);
