...
export function LanguageProvider({
   ...
   * - Persists the language choice to browserStorage
    ...
    async (language: string, isUserAction = true): Promise<void> => {
      ...
      try {
        if (typeof window !== 'undefined') {
          ...
          if (isUserAction) {
            browserStorage.setItem('language_user_selected', 'true');
          }
        }
  ...
  useEffect(() => {
    ...
    const storedLanguage = typeof window !== 'undefined' ? browserStorage.getItem('language') : null;
    const userExplicitChoice =
      typeof window !== 'undefined' ? browserStorage.getItem('language_user_selected') : null;
